...
define(['./workbox-43e44e5a'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    "url": "index.html",
    "revision": "0.t610c771p2s"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/],
    denylist: [/^\/api/, /supabase\.co/i]
  }));
  workbox.registerRoute(/.*\.supabase\.co\/(?:rest|auth|realtime)\/.*/i, new workbox.NetworkOnly(), 'GET');
  ...
  workbox.registerRoute(/.*\.supabase\.co\/storage\/v1\/object\/public\/.*/i, new workbox.CacheFirst({
