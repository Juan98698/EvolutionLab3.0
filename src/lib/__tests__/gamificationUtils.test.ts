...
describe('getISOWeekString', () => {
  it('2025-12-29 es la semana 52 de 2025 (ISO)', () => {
    expect(getISOWeekString(new Date('2025-12-29'))).toBe('2025-W52');
  });

  it('2026-01-05 es la semana 1 de 2026 (ISO)', () => {
    expect(getISOWeekString(new Date('2026-01-05'))).toBe('2026-W01');
  });
  ...
  it('2026-12-28 es la semana 52 de 2026 (2026 no tiene semana 53)', () => {
    expect(getISOWeekString(new Date('2026-12-28'))).toBe('2026-W52');
  });
});
