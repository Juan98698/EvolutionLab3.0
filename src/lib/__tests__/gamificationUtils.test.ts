...
describe('getISOWeekString', () => {
  ...
  // (Este comentario y esta construcción se habían perdido en el commit
  // "corrijo gamificacion panel" al revertir accidentalmente el fix de
  // e883f0b — bajo timezone UTC-5 (Colombia) 3 de estos 4 tests fallaban.)
