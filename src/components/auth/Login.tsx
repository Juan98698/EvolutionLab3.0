    ...
    <div className={`auth-landing-wrapper${isExiting ? ' login-exiting' : ''}`} style={{ display: 'flex', minHeight: '100vh', color: 'white', background: 'transparent', width: '100%', position: 'relative', overflow: 'hidden' }}>
      ...
      <style>{`
        ...
        @keyframes particleFloat {
          ...
          50% { transform: translateY(-18px) scale(1.35); opacity: 0.9; }
        }
        .circuit-trace {
          animation: circuitDashFlow 7s linear infinite;
        }
        .circuit-pad {
          animation: circuitPadPulse 2.6s ease-in-out infinite;
        }
        .circuit-group {
          animation: circuitGroupPulse 9s ease-in-out infinite;
        }
            ...
            {isRecoveryMode ? (
              ...
              <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: '2px 0' }}>
                  ...
                  <span style={{ fontSize: '10px', fontFamily: "'Orbitron', sans-serif", color: 'rgba(255, 255, 255, 0.4)', textTransform: 'uppercase', letterSpacing: '1px' }}>O</span>
                  <div style={{ flex: 1, height: '1px', background: 'rgba(255, 255, 255, 0.08)' }} />
                </div>
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.background = 'rgba(255, 255, 255, 0.08)';
                    e.currentTarget.style.boxShadow = `0 0 12px ${pri}22`;
                  }}
                  onMouseLeave={(e) => {
